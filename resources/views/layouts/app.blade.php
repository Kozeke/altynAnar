            ...
            <div class="support-client hidden-xs">
                <div class="row">
                    <div class="col-md-3 col-sm-12">
                         <div class="logo">
                             <a href="/" title="Malias"><img style="height: auto;width: 100%;margin-bottom: -100px;margin-top:-30px" src="img/logo.png" alt="AltynAnar"></a>
                                       </div>
                                    </div>
                                        <!-- Start Single-Support -->
                                        <div class="col-md-3 hidden-sm" style="margin-top:2%">
                                        ...
                                        <!-- End Single-Support -->
                                        <!-- Start Single-Support -->
                                        <div class="col-md-3 col-sm-4" style="margin-top:2%">
                                            <div class="single-support">
